...
Файл README («прочти меня», англ.) обычно предоставляет обзорные сведения о содержимом папки, в
...
* `README-файл <https://ru.wikipedia.org/wiki/README-файл>`_, *Википедия*
