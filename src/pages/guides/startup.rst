...
В статье «:doc:`/goals`» подробно рассматривается важность понимания аудитории документации.
...
Очевидно, что :doc:`пользователи </reference/recipients/users>` и
:doc:`разработчики </reference/recipients/developers>` будут использовать один и тот же программный
