...
Всё внимание на цели читателя
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
**Всё**, что вы пишите должно определяться **только одним** — стремлением помочь читателю
достигнуть его целей. Ещё раз: цели читателя — **единственное**, что должно определять что, как и
...
^^^^^^^^^^^^^^^^^^^^^^^
Как :doc:`уже было написано </theory/goal>`, задачи мешают достижению цели. Поэтому старайтесь
свести к минимуму время, которое читателю придётся затратить на решение этих задач. Берегите его
время:

* :doc:`в начале статьи </guides/intro/section>` пишите о чём она и её краткое содержание.
...
Пишите для одной конкретной :term:`аудитории <Читательская аудитория>`. Разные читательские
аудитории могут сильно различаться целями, задачами, багажом специфических знаний и мотивацией.
Пытаясь написать один документ для всех, вы, вероятнее всего, не сможете удовлетворить никого. С
точки зрения каждой отдельно взятой аудитории, в вашем документе будет много лишнего, но может не
оказаться нужного.
